...
class TaskFilter(django_filters.FilterSet):
    ...
    completion_date__gte = django_filters.DateFilter(field_name='completion_date', lookup_expr='gte')  # after or on
    completion_date__lte = django_filters.DateFilter(field_name='completion_date', lookup_expr='lte')  # before or on

    class Meta:
        model = Task
        fields = ['key', 'name', 'job_no', 'position_no', 'image_no', 'completed_by', 'completion_date']
