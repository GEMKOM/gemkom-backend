...
from .views import (
    BasisChoicesView, PaymentTermsViewSet, PurchaseOrderViewSet, PurchaseRequestDraftViewSet, StatusChoicesView, SupplierViewSet, ItemViewSet,
...
urlpatterns = [
    ...
    path('basis-choices/', BasisChoicesView.as_view(), name="basis-list"),
]
