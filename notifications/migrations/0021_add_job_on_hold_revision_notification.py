...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('notifications', '0020_add_job_date_changed_notification'),
    ]
    ...
    operations = [
        ...
        migrations.RunSQL(
            ...
            VALUES (
                'job_on_hold_revision',
                '[İş Emri Revizyonda] {job_no}',
            ...
            """,
            reverse_sql="DELETE FROM notifications_notificationconfig WHERE notification_type = 'job_on_hold_revision';",
        ),
    ]
